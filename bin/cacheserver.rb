...
if __FILE__==$0 || $0=='<script>'
	...
	cache www.sogou.com:80 127.0.0.01:1080 127.0.0.1:65531
	"
	target_host, target_port=ARGV[0].split(':')
	proxy_host, proxy_port=ARGV[1].split(':')
...
=begin
	...
	@cache.start
=end
	config={"host"=>proxy_host,'port'=>proxy_port.to_i, 'forward_host'=>target_host, "forward_port"=>target_port.to_i}
